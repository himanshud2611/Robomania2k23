...
$(window).load(function(){
  var $post_para = $(".post-para"),
      ...
      $pre_para.removeClass("invisible"); $digm.text("Mania");
   setTimeout(function(){$pre_para.shuffleLetters({ "text": "Welcome" });$digm.shuffleLetters({ "text": "Mania" });$digm.text("Mania");},1000);
   setTimeout(function(){$pre_para.shuffleLetters({ "text": "to" });$digm.shuffleLetters({ "text": "Mania" });$digm.text("Mania");},2000);


   setTimeout(function(){$pre_para.addClass("invisible");$post_para.fadeIn(600); $digm.text("Mania");},3000);
});
